...
const environment = {
  ...
  JWT_ADMIN_SECRET: process.env.JWT_ADMIN_SECRET || 'trade_secret_$$&$admin',
  JWT_VALIDITY: process.env.JWT_VALIDITY || '10d',
  LOGIN_HARD_LIMIT_ADMIN: process.env.LOGIN_HARD_LIMIT_ADMIN || 3,
  LOGIN_ID: process.env.loginId || 'DC-VRUN3041',
  PRODUCT: process.env.product || 'DIRECTRTLITE',
  API_KEY: process.env.apiKey || '12B27F9642274BF490A5',
